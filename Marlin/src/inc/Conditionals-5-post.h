...
// Thermal protection
#if ENABLED(MODULE_THERMAL_PROTECTION) && (WATCH_HEAT_PERIOD > 0 || WATCH_COOL_PERIOD > 0)
...
#endif
#if NONE(MODULE_THERMAL_PROTECTION, THERMAL_PROTECTION_CHAMBER, THERMAL_PROTECTION_BED, THERMAL_PROTECTION_COOLER)
  #undef THERMAL_PROTECTION_VARIANCE_MONITOR
#endif
#if  (ENABLED(MODULE_THERMAL_PROTECTION) || !HOTENDS) \
...
// SPI Flash Backup
  ...
  #define HAS_CONSTANT_EXTRUSION 1
